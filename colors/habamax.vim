...
" Last Updated: 14.02.2022 21:08:56
...
if &background ==# 'dark'
  ...
  hi debugBreakpoint guifg=NONE guibg=#d7875f gui=NONE cterm=NONE
  ...
  hi SpellRare guifg=#d7d787 guibg=NONE guisp=#d7d787 gui=undercurl cterm=underline
  hi debugPC guifg=NONE guibg=#005faf gui=NONE cterm=NONE
  hi debugBreakpoint guifg=NONE guibg=#af5f00 gui=NONE cterm=NONE
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    hi SpellRare ctermfg=186 ctermbg=NONE cterm=underline
    hi debugPC ctermfg=NONE ctermbg=25 cterm=NONE
    hi debugBreakpoint ctermfg=NONE ctermbg=130 cterm=NONE
...
if s:t_Co >= 16
  if &background ==# 'dark'
    ...
    hi debugPC ctermfg=NONE ctermbg=blue cterm=NONE
