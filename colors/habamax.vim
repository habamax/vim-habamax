...
" Last Updated: 02.02.2022 20:27:42
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  hi DiffChange guifg=#87875f guibg=#262626 gui=reverse cterm=reverse
  hi DiffText guifg=#5faf5f guibg=#262626 gui=reverse cterm=reverse
  hi DiffDelete guifg=#5f8787 guibg=#262626 gui=reverse cterm=reverse
  if &background ==# 'dark'
...
if s:t_Co >= 256
  ...
  hi! link StatuslineTermNC StatuslineNC
  hi! link TabLineFill TabLine
  hi DiffAdd ctermfg=65 ctermbg=235 cterm=reverse
  hi DiffChange ctermfg=101 ctermbg=235 cterm=reverse
  hi DiffText ctermfg=71 ctermbg=235 cterm=reverse
  hi DiffDelete ctermfg=66 ctermbg=235 cterm=reverse
  if &background ==# 'dark'
