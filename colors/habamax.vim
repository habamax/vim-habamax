...
" Last Updated: 01.03.2022 21:09:45
...
if &background ==# 'dark'
  ...
  hi MatchParen guifg=#262626 guibg=#87afaf gui=NONE cterm=NONE
  ...
  hi CursorLineNr guifg=#af5f00 guibg=NONE gui=bold cterm=NONE
  ...
  hi IncSearch guifg=#e4e4e4 guibg=#af5f00 gui=NONE cterm=NONE
  ...
  hi Cursor guifg=#e4e4e4 guibg=#af5f00 gui=NONE cterm=NONE
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    hi MatchParen ctermfg=235 ctermbg=109 cterm=NONE
    ...
    hi IncSearch ctermfg=254 ctermbg=130 cterm=NONE
    hi WildMenu ctermfg=235 ctermbg=186 cterm=NONE
...
if s:t_Co >= 16
  if &background ==# 'dark'
    ...
    hi MatchParen ctermfg=black ctermbg=cyan cterm=NONE
