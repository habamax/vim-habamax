...
" Last Updated: 10.03.2022 10:41:46
...
if &background ==# 'dark'
  ...
  hi Terminal guifg=#bcbcbc guibg=#262626 gui=NONE cterm=NONE
  hi Statusline guifg=#262626 guibg=#9e9e9e gui=NONE cterm=NONE
  hi StatuslineTerm guifg=#262626 guibg=#9e9e9e gui=NONE cterm=NONE
  hi StatuslineTermNC guifg=#262626 guibg=#767676 gui=NONE cterm=NONE
  ...
  hi TabLineFill guifg=#262626 guibg=#767676 gui=NONE cterm=NONE
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    hi StatuslineTerm ctermfg=235 ctermbg=247 cterm=NONE
    hi StatuslineTermNC ctermfg=235 ctermbg=243 cterm=NONE
    ...
    hi TabLineFill ctermfg=235 ctermbg=243 cterm=NONE
