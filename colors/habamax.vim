...
" Last Updated: Sun Mar 13 20:30:55 2022
...
if &background ==# 'dark'
  if (has('termguicolors') && &termguicolors) || has('gui_running')
    let g:terminal_ansi_colors = ['#1c1c1c', '#d75f5f', '#87af87', '#afaf87', '#5f87af', '#af87af', '#5f8787', '#9e9e9e', '#767676', '#df875f', '#afd7af', '#dfdf5f', '#87afd7', '#dfafdf', '#87afaf', '#bcbcbc']
  endif
  ...
  hi ModeMsg guifg=#1c1c1c guibg=#dfdf5f gui=NONE cterm=NONE
  ...
  hi Todo guifg=#dfdf5f guibg=#1c1c1c gui=reverse cterm=reverse
  hi MatchParen guifg=#1c1c1c guibg=#5f8787 gui=NONE cterm=NONE
  hi Search guifg=#1c1c1c guibg=#87af87 gui=NONE cterm=NONE
  hi IncSearch guifg=#1c1c1c guibg=#ffaf5f gui=NONE cterm=NONE
  hi WildMenu guifg=#1c1c1c guibg=#dfdf5f gui=NONE cterm=NONE
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    hi ModeMsg ctermfg=234 ctermbg=185 cterm=NONE
    ...
    hi Todo ctermfg=185 ctermbg=234 cterm=reverse
    hi MatchParen ctermfg=234 ctermbg=66 cterm=NONE
    hi Search ctermfg=234 ctermbg=108 cterm=NONE
    hi IncSearch ctermfg=234 ctermbg=215 cterm=NONE
    hi WildMenu ctermfg=234 ctermbg=185 cterm=NONE
...
" Color: color11     #DFDF5F        185            yellow
...
" Color: color05pre  #AF8787        138            darkyellow
