...
" Last Updated: 02.03.2022 11:28:14
...
if &background ==# 'dark'
  ...
  hi CursorLineNr guifg=#ff005f guibg=NONE gui=bold cterm=NONE
  ...
  hi Search guifg=#e4e4e4 guibg=#0000ff gui=NONE cterm=NONE
  hi IncSearch guifg=#e4e4e4 guibg=#ff005f gui=NONE cterm=NONE
  ...
  hi Cursor guifg=#e4e4e4 guibg=#ff005f gui=NONE cterm=NONE
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    hi Search ctermfg=254 ctermbg=21 cterm=NONE
    hi IncSearch ctermfg=254 ctermbg=197 cterm=NONE
    hi WildMenu ctermfg=235 ctermbg=186 cterm=NONE
