...
" Last Updated: 12.01.2022 11:46:59
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  if &background ==# 'dark'
    let g:terminal_ansi_colors = ['#262626', '#d75f5f', '#87af87', '#afaf87', '#5f87af', '#af87af', '#5f8787', '#949494', '#626262', '#d7875f', '#afd7af', '#d7d787', '#87afd7', '#d7afd7', '#87afaf', '#dadada']
    hi Normal guifg=#dadada guibg=#262626 gui=NONE cterm=NONE
    ...
    hi CursorLineNr guifg=#afaf87 guibg=#303030 gui=bold cterm=bold
  ...
  hi SpellRare guifg=#d7d787 guibg=NONE guisp=#d7d787 gui=undercurl cterm=underline
  hi CursorLineNr guifg=#875f00 guibg=#d0d0d0 gui=bold cterm=bold
...
if s:t_Co >= 256
  ...
  if &background ==# 'dark'
    ...
    hi CursorLineNr ctermfg=144 ctermbg=236 cterm=bold
  ...
  hi SpellRare ctermfg=186 ctermbg=NONE cterm=underline
  hi CursorLineNr ctermfg=94 ctermbg=252 cterm=bold
...
if s:t_Co >= 16
  ...
  if &background ==# 'dark'
    ...
    hi CursorLineNr ctermfg=darkyellow ctermbg=darkgrey cterm=bold
  ...
  hi SpellLocal ctermfg=magenta ctermbg=NONE cterm=underline
  hi SpellRare ctermfg=yellow ctermbg=NONE cterm=underline
  hi CursorLineNr ctermfg=darkyellow ctermbg=grey cterm=bold
...
" Color: color15     #DADADA        250            white
