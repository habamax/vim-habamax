...
" Last Updated: Sat Mar  5 11:34:12 2022
...
if &background ==# 'dark'
  ...
  hi DiffText guifg=#ffffff guibg=#5fafaf gui=NONE cterm=NONE
  ...
  hi DiffDelete guifg=#000000 guibg=#d787d7 gui=NONE cterm=NONE
endif
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    hi DiffText ctermfg=231 ctermbg=73 cterm=NONE
    ...
    hi DiffDelete ctermfg=16 ctermbg=176 cterm=NONE
  endif
  unlet s:t_Co
  finish
endif
...
" Color: bgDiffD     #AF5FAF        133            darkmagenta
" Color: bgDiffT     #5FAFAF        73             darkcyan
" Color: fgDiff      #FFFFFF        231            white
" Background: light
" Color: bgDiffA     #87AF87        108            green
" Color: bgDiffC     #87AFD7        110            blue
" Color: bgDiffD     #D787D7        176            magenta
" Color: bgDiffT     #5FD7D7        80             cyan
