...
" Last Updated: Fri 03 Jun 2022 21:00:47 MSK
...
if s:t_Co >= 8
  ...
  hi LineNrAbove ctermfg=grey ctermbg=NONE cterm=bold
  hi LineNrBelow ctermfg=grey ctermbg=NONE cterm=bold
  hi NonText ctermfg=grey ctermbg=NONE cterm=bold
  hi EndOfBuffer ctermfg=grey ctermbg=NONE cterm=bold
  hi SpecialKey ctermfg=grey ctermbg=NONE cterm=bold
  ...
  hi DiffDelete ctermfg=black ctermbg=darkmagenta cterm=NONE
  unlet s:t_Co
  finish
endif
