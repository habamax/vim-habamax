...
" Last Updated: 07.01.2022 19:39:17
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  hi WildMenu guifg=#dadada guibg=#5f8787 gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi WildMenu ctermfg=253 ctermbg=66 cterm=NONE
...
if s:t_Co >= 16
  ...
  hi WildMenu ctermfg=white ctermbg=cyan cterm=NONE
  hi SpellBad ctermfg=darkred ctermbg=NONE cterm=underline
  hi SpellCap ctermfg=red ctermbg=NONE cterm=underline
  hi SpellLocal ctermfg=magenta ctermbg=NONE cterm=underline
  hi SpellRare ctermfg=yellow ctermbg=NONE cterm=underline
