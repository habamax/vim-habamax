...
" Last Updated: 14.02.2022 20:56:14
...
if &background ==# 'dark'
  ...
  hi CursorLineNr guifg=#ff875f guibg=NONE gui=bold cterm=bold
  ...
  hi IncSearch guifg=#ffffff guibg=#ff875f gui=NONE cterm=NONE
  hi WildMenu guifg=#262626 guibg=#d7d787 gui=NONE cterm=NONE
  ...
  hi SpellRare guifg=#d7d787 guibg=NONE guisp=#d7d787 gui=undercurl cterm=underline
  hi Cursor guifg=#ffffff guibg=#ff875f gui=NONE cterm=NONE
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    hi IncSearch ctermfg=231 ctermbg=209 cterm=NONE
    hi WildMenu ctermfg=235 ctermbg=186 cterm=NONE
